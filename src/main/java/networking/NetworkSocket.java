...
/**
 * Represents a basic socket which can send data to, or receive data from, the
 * remote socket.
 *
 * @author Tom Galvin
 */
public interface NetworkSocket {
	...
	/**
	 * Gets the event which is fired when data is received from the remote
	 * socket.
	 *
	...
	/**
	 * Gets the event which is fired when the connection maintained by this
	 * socket is closed, either due to network connections, or either end of the
	 * connection terminating the socket.
	 *
