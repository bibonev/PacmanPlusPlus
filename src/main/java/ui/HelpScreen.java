...
public class HelpScreen extends Screen{
	...
	public HelpScreen(GameUI game) {
		...
		centrePane.getChildren().addAll(multi, multiDesc1, multiplayer, multiDesc2, startNew,multiDesc3,
				gameSettings, multiDesc4, start, multiDesc5);
		rightPane.getChildren().addAll(joinMulti, multiDesc5a, multiplayer2, multiDesc6, join,
						multiDesc7,leave,multiDesc8, start2, multiDesc9);
